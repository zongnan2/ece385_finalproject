...
# setting SOPC_SYSID_BASE_ADDRESS is 0x90
SOPC_SYSID_FLAG += --sidp=0x90
ELF_PATCH_FLAG  += --sidp 0x90

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1574017123
SOPC_SYSID_FLAG += --timestamp=1574017123
ELF_PATCH_FLAG  += --timestamp 1574017123
